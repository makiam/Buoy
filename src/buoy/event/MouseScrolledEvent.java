...
public class MouseScrolledEvent extends MouseWheelEvent implements WidgetEvent {
     ...
     * @param scrollType the type of scrolling which should occur in response to
     * this event (either WHEEL_UNIT_SCROLL or WHEEL_BLOCK_SCROLL)
     * @param scrollAmount the number of units which should be scrolled in

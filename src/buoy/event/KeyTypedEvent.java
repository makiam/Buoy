...
/**
 * This is an event corresponding to a Unicode character being generated by the
 * user interacting with the keyboard. The exact relationship between the
 * keyboard interaction and the resulting KeyTypedEvents may be complex. Several
 * different key presses may contribute to a single KeyTypedEvent (such as
 * holding down the Shift key while typing a letter), or a single key press may
 * generate multiple KeyTypedEvents (such as holding down a key to activate
 * autorepeat).
 *

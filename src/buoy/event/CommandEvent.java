...
public class CommandEvent extends ActionEvent implements WidgetEvent {
     ...
     * @param modifiers describes the state of various keys at the time when the
     * event occurred (a sum of the constants defined by ActionEvent)
     */
     ...
     * @param modifiers describes the state of various keys at the time when the
     * event occurred (a sum of the constants defined by ActionEvent)
     * @param command the command String describing the action which was
     * performed
     */

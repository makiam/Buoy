...
/**
 * This class is a PersistenceDelegate for serializing a variety of
 * WidgetContainers. It assumes the container has a list of children which are
 * indexed by a single integer, and that children can be added to it by calling
 * an "add" method.
 *
...
public class IndexedContainerDelegate extends EventSourceDelegate {
     ...
     *
     * @param propertyMethods the names of a set of public methods which take an
     * int as their only argument. For each child of the container, these

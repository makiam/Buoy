...
/**
 * This class is a PersistenceDelegate for serializing EventSources. It extends
 * DefaultPersistenceDelegate to record the list of event links.
 *
...
public class EventSourceDelegate extends DefaultPersistenceDelegate {
    ...
    /**
     * This is a utility routine. It uses reflection to look up the value of a
     * particular field of an object. It makes use of the AccessibleObject API
     * so that it can access private and protected fields of other classes.
     *

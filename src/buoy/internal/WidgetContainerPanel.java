...
/**
 * This is a JPanel subclass, which is used as the Component for many different
 * WidgetContainers. When paintComponent() is called, it optionally fills itself
 * with its background color then sends out a RepaintEvent.
 *

 ...
 * dragging a "thumb" along a bar. It can optionally show tick marks, labels, or
 * both along the bar.
 * <p>
 * In addition to the event types generated by all Widgets, BSliders generate
...
public class BSlider extends Widget {
     ...
     * @param orientation defines how the BSlider should be drawn and
    ...
    /**
     * Create the JSlider which serves as this Widget's Component. This method
     ...
     * <p>
     * The major tick spacing can never be smaller than the minor tick spacing.
     * If the current minor tick spacing is greater than the value passed to
     * this method, then the minor tick spacing will also be set to the same
     * value.
     */
     ...
     * <p>
     * The minor tick spacing can never be larger than the major tick spacing.
     * If the current major tick spacing is less than the value passed to this
    ...
    /**
     * Get whether the thumb of the slider should always snap to the nearest
     * tick position.
     */
    ...
    /**
     * Set whether the thumb of the slider should always snap to the nearest
     * tick position.
     */

 ...
 * {@link BRadioButtonMenuItem BRadioButtonMenuItems}. It ensures that only one
 * member of the group is selected at any time. It provides methods for
 * determining which member is currently selected, and for changing the
 * selection.
 * <p>
 * RadioButtonGroup extends {@link buoy.event.EventSource EventSource}. It
 * generates a {@link buoy.event.SelectionChangedEvent SelectionChangedEvent}
 * whenever the user changes the selected radio button. Therefore, you can
 * simply add an event link to a RadioButtonGroup, rather than adding one to
 * each radio button independently.
 *
...
public class RadioButtonGroup extends EventSource {
    ...
    /**
     * Add a BRadioButton to this group. This is called from the BRadioButton
     * constructor.
     */
    ...
    /**
     * Add a BRadioButtonMenuItem to this group. This is called from the
     * BRadioButtonMenuItem constructor.
     */
    ...
    /**
     * When the user clicks a radio button, deselect all others and forward the
     * event.
     */

...
/**
 * A Widget is a graphical object. It occupies a fixed region of the screen, and
 * can respond to user actions. This is an abstract class. There are subclasses
 * corresponding to particular kinds of Widgets.
 * <p>
 * Every Widget is mapped to a specific AWT/Swing Component. This class can
 * therefore be thought of as a wrapper around the Component class.
 * <p>
...
public abstract class Widget extends EventSource {
    ...
    /**
     * This method should be called any time this Widget's minimum, maximum, or
     * preferred size changes. The default implementation simply calls
     * invalidateSize() on the Widget's parent. Subclasses that cache layout
     * information should override this to discard the cached information.
     */
    ...
    /**
     * Request that this Widget be repainted. This method does not actually
     * paint the Widget immediately. Instead, it causes a repaint request to be
     * placed onto the global event queue. As a result, this method can be
    ...
    /**
     * Get the background color of this Widget. If that is null and this Widget
     * has been added to a WidgetContainer, this returns the background color of
    ...
    /**
     * Set the font used to draw text in this Widget. If this is set to null,
     * the Widget will use the Font of its parent WidgetContainer.
     */
    ...
    /**
     * Determine whether this Widget currently has keyboard focus, so that
     * WidgetKeyEvents will be sent to it.
     */
    ...
    /**
     * Request that keyboard focus be transferred to this Widget, so that
     * WidgetKeyEvents will be sent to it.
     */
    ...
    /**
     * Determine whether this Widget can receive keyboard focus through the user
     * pressing Tab or Shift-Tab to cycle between Widgets.
     */
    ...
    /**
     * Set whether this Widget can receive keyboard focus through the user
     * pressing Tab or Shift-Tab to cycle between Widgets.
     */
    ...
    /**
     * Get the name of this Widget. This is used primarily to identify Widgets
     * when they are serialized to XML files.
     */
    ...
    /**
     * Set the name of this Widget. This is used primarily to identify Widgets
     * when they are serialized to XML files.
     */

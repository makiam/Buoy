...
/**
 * A LayoutInfo object contains information about how a Widget should be layed
 * out within the space provided by its WidgetContainer. Most containers allow
 * you to specify a default LayoutInfo for all Widgets, and also to specify a
 * different one for each Widget.
 * <p>
 * It is permitted to reuse a single LayoutInfo object for multiple Widgets. In
 * that case, any change made to the LayoutInfo will affect all Widgets for
 * which it is used.
 *
...
public class LayoutInfo implements Cloneable {
    ...
    /**
     * Create a LayoutInfo object with the following default values: no padding,
     * no insets, center alignment, and no fill.
     */
    public LayoutInfo() {
     ...
     *
     * @param align the alignment of the Widget. This should be equal to one of
     * the alignment constants defined by this class: CENTER, NORTH, NORTHEAST,
     * EAST, etc.
     * @param fill specifies whether the Widget should grow to fill the
     * available space. This should be equal to NONE, HORIZONTAL, VERTICAL,
     * BOTH.
     */
     ...
     * available space. This should be equal to NONE, HORIZONTAL, VERTICAL,
     * BOTH.
     * @param insets specifies extra space (in pixels) that should be added
     * around the Widget. If this is null, no insets will be used.
     * @param padding extra padding, in pixels. This requests that the Widget be
     * made larger than its preferred size. If this is null, no padding will be
     * used.
     */
    ...
    /**
     * Get the alignment of the Widget within its available space. This should
     * be equal to one of the alignment constants defined by this class: CENTER,
    ...
    /**
     * Set the alignment of the Widget within its available space. This should
     * be equal to one of the alignment constants defined by this class: CENTER,
     * NORTH, NORTHEAST, EAST, etc.
     */
    ...
    /**
     * Get whether the Widget should grow to fill the available space. This
     * should be equal to NONE, HORIZONTAL, VERTICAL, BOTH.
     */
    ...
    /**
     * Set whether the Widget should grow to fill the available space. This
     * should be equal to NONE, HORIZONTAL, VERTICAL, BOTH.
     */
     ...
     * If this is null, no insets will be used.
     */
    ...
    /**
     * Get the extra padding, in pixels, that should be added to the preferred
     * size of the Widget. If this is null, no padding will be used.
     */
    ...
    /**
     * Set the extra padding, in pixels, that should be added to the preferred
     * size of the Widget. If this is null, no padding will be used.
     */
    ...
    /**
     * Get the preferred size of a Widget, taking into account the insets and
     * padding specified by this object.
     */
    ...
    /**
     * Get the maximum size of a Widget, taking into account the insets and
     * padding specified by this object.
     */
    ...
    /**
     * Given a Widget, and a Rectangle in which to position it, return the
     * desired bounds of the Widget.
     *
     * @param widget the Widget to position
     * @param rect the rectangle within which the Widget should be positioned.
     * This is typically the region a WidgetContainer has set aside for this
     * particular Widget.

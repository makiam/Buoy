...
/**
 * ExplicitContainer is a WidgetContainer which allows the sizes and positions
 * of its children to be set explicitly.
 * <p>
 * In addition to the event types generated by all Widgets, ExplicitContainers
...
public class ExplicitContainer extends WidgetContainer {
     ...
     * @return the bounding rectangle to be used for the Widget, or null if it

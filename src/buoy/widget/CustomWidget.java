...
/**
 * A CustomWidget is used for defining new graphical objects. It occupies a
 * rectangular region of a window, and its preferred, minimum, and maximum sizes
 * can all be modified.
 * <p>
 * In addition to the event types generated by all Widgets, CustomWidgets
...
public class CustomWidget extends Widget {
    ...
    /**
     * Set the smallest size at which this Widget can reasonably be drawn. When
    ...
    /**
     * Set the largest size at which this Widget can reasonably be drawn. When a
    ...
    /**
     * Set the preferred size at which this Widget will look best. When a
    ...
    /**
     * Determine whether this Widget is set to be opaque. If true, then it will
     * be filled with its background color before RepaintEvents are sent out. If
     * false, the parent container will show through.
     */
    ...
    /**
     * Set whether this Widget should be opaque. If true, then it will be filled
     * with its background color before RepaintEvents are sent out. If false,
     * the parent container will show through.
     */

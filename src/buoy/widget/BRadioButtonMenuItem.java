 ...
 * It is normally used as part of a {@link RadioButtonGroup RadioButtonGroup}.
 * Each BRadioButtonMenuItem represents a single option. Choosing it from the
 * menu selects it, and deselects all other members of its RadioButtonGroup.
 * <p>
 * In addition to the event types generated by all Widgets,
 * BRadioButtonMenuItems generate the following event types:
 * <ul>
...
public class BRadioButtonMenuItem extends BMenuItem {
    ...
    /**
     * Create a new BRadioButtonMenuItem with no label, which is initially
     * deselected.
     *
    ...
    /**
     * Set the selection state of this menu item. If you set the selection state
     * to true, the state of every other member of its RadioButtonGroup will be
     * set to false.
     */

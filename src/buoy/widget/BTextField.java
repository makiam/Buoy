...
/**
 * A BTextField is a simple text entry box. It allows the user to enter a single
 * line of text.
 * <p>
 * In addition to the event types generated by all Widgets, BTextFields generate
...
public class BTextField extends TextWidget {
    ...
    /**
     * Set the number of columns this text field should be wide enough to
     * display.
     */

...
/**
 * GridContainer is a WidgetContainer which arranges its child Widgets in a
 * uniform grid. Every column is the same width, and every row is the same
 * height.
 * <p>
 * In addition to the event types generated by all Widgets, GridContainers
...
public class GridContainer extends WidgetContainer {
     ...
     * it. If there is already a Widget in the specified cell, that one will be
     ...
     * specified cell, that one will be removed before the new one is added.
     *
     * @param widget the Widget to add
     * @param col the column in which to place the Widget
     * @param row the row in which to place the Widget
     ...
     * @return the LayoutInfo being used for that cell. This may return null,
    ...
    /**
     * Set the number of rows in the grid. If this causes the grid to shrink,
     * all Widgets which do not fit into the new grid will be removed.
     */
    ...
    /**
     * Set the number of columns in the grid. If this causes the grid to shrink,
     * all Widgets which do not fit into the new grid will be removed.
     */
     ...
     * @return a Point containing the row and column where the Widget is
     * located, or null if the Widget is not a child of the container
     */

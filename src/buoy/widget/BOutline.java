 ...
 * The appearance of the outline is determined by a javax.swing.border.Border
 * object. There are static methods for creating several common types of
 * outlines, or you can use a different type by providing your own Border
 * object.
 *
...
public class BOutline extends WidgetContainer {
     ...
     *
     * @param content the Widget to use as the content of the BOutline
     * @param raised if true, the border will have a raised appearance. If
     * false, it will have a lowered appearance.
     */

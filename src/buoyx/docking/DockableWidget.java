...
/**
 * This is a Widget that can be added to a {@link DockingContainer}, and
 * rearranged by the user. It is a container which holds a single content Widget
 * and draws a border around it. By clicking on the border, the user can drag
 * the DockableWidget to any other DockingContainer in the same window, group
 * the Widgets in a DockingContainer into tabs, and reorder the Widgets within a
 * tab.
 * <p>
 * The border drawn by this class consists of a fairly simple title bar. You can
 * change the appearance of the border by creating a subclass and overriding {@link #getBorderInsets()},
 * {@link #paintBorder(java.awt.Graphics2D)}, and
 * {@link #isInDragRegion(java.awt.Point)}.
 *
...
public class DockableWidget extends WidgetContainer {
    ...
    /**
     * This method is called to determine the thickness of the border on each
     * side. If you customize the appearance of the border, override this method
    ...
    /**
     * When the user clicks inside the DockableWidget, this method is called to
     * determine whether the click was in the "drag region". If it returns true,
     * a drag operation will be initiated to move the DockableWidget to a new
     * location.
     */

...
/**
 * A BPasswordField is a simple text entry box for typing passwords. It allows
 * the user to enter a single line of text. The characters typed into the box
 * are hidden, and an alternate echo character is displayed instead.
 * <p>
 * In addition to the event types generated by all Widgets, BPasswordFields
...
public class BPasswordField extends BTextField {
     ...
     * Create a new BPasswordField.
     *
     * @param columns the number of columns this text field should be wide
     * enough to display
     */

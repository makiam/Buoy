...
/**
 * A BComboBox is a Widget that displays a popup menu with a list of objects for
 * the user to select. Typically the objects are Strings, but other types of
 * objects can be used as well. Optionally, the combo box may be made editable,
 * so the user may type a value directly rather than selecting one from the
 * list. This allows arbitrary values to be entered, not just standard ones in
 * the list.
 * <p>
 * BComboBox provides methods for adding and removing objects in the list.
 * Alternatively, you can set a ComboBoxModel to provide more complex behaviors.
 * <p>
 * In addition to the event types generated by all Widgets, BComboBoxes generate
...
public class BComboBox extends Widget<JComboBox> {
    ...
    /**
     * Create a new uneditable BComboBox whose contents are determined by a
     * ComboBoxModel.
     */
    ...
    /**
     * Create the JComboBox which serves as this Widget's Component. This method
    ...
    /**
     * Set whether this combo box is editable, allowing the user to type in
     * values other than those in the popup list.
     */
    ...
    /**
     * Get the preferred number of rows which should be visible in the popup
    ...
    /**
     * Get the index of the selected item. If this is an editable combo box and
    ...
    /**
     * Get the current value which has been selected from the list or, if this
    ...
    /**
     * Set the value shown in the combo box. If this combo box is not editable
     * and the specified value is not a member of the list, this will have no
     * effect.
     */

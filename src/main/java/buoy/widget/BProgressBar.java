...
/**
 * BProgressBar is a Widget that displays the status of some operation. It is a
 * horizontal or vertical bar that gradually fills up to indicate what fraction
 * of the operation is complete. It optionally can also display a line of text
 * describing the current state of the operation.
 * <p>
 * You can specify minimum and maximum progress values for the bar, to reflect
 * the number of steps in the operation being monitored. When the current
 * progress value is equal to the minimum value, the bar is shown completely
 * empty. When it is equal to the maximum value, the bar is shown completely
 * full.
 * <p>
 * If you do not know how long an operation will take, the progress bar can be
 * put into an "indeterminate" state. This causes the entire bar to animate
 * continuously to show that work is being done.
 *
...
public class BProgressBar extends Widget<JProgressBar> {
    ...
    /**
     * Create a horizontal BProgressBar which does not display text. The minimum
     * and maximum progress values are 0 and 100, respectively.
     */
    public BProgressBar() {
    ...
    /**
     * Create a horizontal BProgressBar which does not display text. The initial
     * progress value is set to min.
     *
    ...
    /**
     * Create the JProgressBar which serves as this Widget's Component. This
    ...
    /**
     * Get whether this progress bar is in indeterminate mode. In indeterminate
     * mode, the entire progress bar animates continuously to show that work is
    ...
    /**
     * Set whether this progress bar is in indeterminate mode. In indeterminate
     * mode, the entire progress bar animates continuously to show that work is
     * being done, but no indication is given of how much remains.
     */
    ...
    /**
     * Get whether the progress bar displays a line of text describing the
    ...
    /**
     * Set whether the progress bar displays a line of text describing the
     * operation whose progress is being monitored.
     */

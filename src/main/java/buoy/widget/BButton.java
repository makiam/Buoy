...
/**
 * A BButton is a push button Widget. Its appearance can be customized by setting
 * the text and/or image which appears on it.
 * <p>
 * In addition to the event types generated by all Widgets, BButtons generate
 ...
 */
public class BButton extends Widget<JButton> {
    ...
    public BButton() {
        ...
        component.addActionListener(ev -> dispatchEvent(new CommandEvent(BButton.this, ev.getWhen(), ev.getModifiers(), component.getActionCommand())));
    }
    ...
    /**
     * Create the JButton which serves as this Widget's Component. This method
     ...
     * the alignment constants defined by this class: CENTER, NORTH, NORTHEAST,
     * EAST, etc. If this BButton does not display both text and an image, this

...
/**
 * A BLabel is a Widget that displays a text string, an image, or both. The text
 * may be specified as HTML, allowing it to contain complex formatting, multiple
 * fonts, etc.
 *
...
public class BLabel extends Widget<JLabel> {
     ...
     *
     * @param text the text to display on the BLabel
     * @param align the alignment of the label contents (CENTER, NORTH,
     * NORTHEAST, etc.)
     */
     ...
     * @param align the alignment of the label contents (CENTER, NORTH,
     * NORTHEAST, etc.)
     * @param textPos the position of the text relative to the image (CENTER,
     * NORTH, NORTHEAST, etc.)
     */
    ...
    /**
     * Create the JLabel which serves as this Widget's Component. This method is
    ...
    /**
     * Get the alignment of the label's contents. This will be one of the
     * alignment constants defined by this class: CENTER, NORTH, NORTHEAST,
     * EAST, etc.
     */
    ...
    /**
     * Set the alignment of the label's contents. This should be one of the
     * alignment constants defined by this class: CENTER, NORTH, NORTHEAST,
     * EAST, etc.
     */
    ...
    /**
     * Get the position of the text relative to the image. This will be one of
    ...
    /**
     * Set the position of the text relative to the image. This should be one of
     * the alignment constants defined by this class: CENTER, NORTH, NORTHEAST,
     * EAST, etc. If this BLabel does not display both text and an image, this

...
/**
 * A BScrollPane is a WidgetContainer with up to five children: an arbitrary
 * "content" Widget that fills most of the BScrollPane, optional "row header"
 * and "column header" Widgets along the left and top edges, respectively, and
 * optional BScrollBars along the right and bottom edges. It displays only a
 * portion of the content, row header, and column header Widgets, and allows the
 * user to scroll through them by means of the two BScrollBars.
 * <p>
 * If the BScrollPane does not have a horizontal and/or vertical scrollbar, then
 * by default it will force the corresponding dimension of the content and
 * header Widgets to exactly match the size of the visible area. For example, if
 * the content is a BTextArea with word wrap enabled, you would normally only
 * have a vertical scrollbar. The width of the BTextArea should then be forced
 * to exactly match the width of the visible area, so that words will wrap at
 * the correct place. You can override this behavior by calling setForceWidth()
 * and setForceHeight(). For example, you might want to control the scroll
 * position through some external means, in which case the BScrollPane would not
 * provide scrollbars but should still allow the content Widget to be its
 * preferred size.
 *
...
public class BScrollPane extends WidgetContainer<JScrollPane> {
    ...
    /**
     * Create a new BScrollPane with no content or header Widgets. The
     * horizontal and vertical scrollbar policies default to
     * SCROLLBAR_AS_NEEDED.
     */
    public BScrollPane() {
    ...
    /**
     * Create a new BScrollPane with the specified Widget as its content. The
     * horizontal and vertical scrollbar policies default to
     * SCROLLBAR_AS_NEEDED.
     *
     ...
     *
     * @param horizontalPolicy specifies when the horizontal scrollbar should be
     * displayed. This should be equal to SCROLLBAR_ALWAYS, SCROLLBAR_AS_NEEDED,
     * or SCROLLBAR_NEVER.
    ...
    /**
     * Create the JScrollPane which serves as this Widget's Component. This
    ...
    /**
     * Get the horizontal scrollbar policy. This will be either
     * SCROLLBAR_ALWAYS, SCROLLBAR_AS_NEEDED, or SCROLLBAR_NEVER.
     */
    ...
    /**
     * Set the horizontal scrollbar policy. This should be either
     * SCROLLBAR_ALWAYS, SCROLLBAR_AS_NEEDED, or SCROLLBAR_NEVER.
     */
    ...
    /**
     * Get the vertical scrollbar policy. This will be either SCROLLBAR_ALWAYS,
    ...
    /**
     * Set the vertical scrollbar policy. This should be either
     * SCROLLBAR_ALWAYS, SCROLLBAR_AS_NEEDED, or SCROLLBAR_NEVER.
     */
    ...
    /**
     * Get the preferred size for the content's view area. This may be null, in
     * which case the preferred view size is equal to the preferred size of the
     * content Widget.
     */
    ...
    /**
     * Set the preferred size for the content's view area. This may be null, in
     * which case the preferred view size is equal to the preferred size of the
     * content Widget.
     */
    ...
    /**
     * Get whether the BScrollPane should force the width of the content and
     * column header Widgets to exactly match the width of the visible area. By
     * default, this is true if the horizontal scrollbar policy was initialized
     * to SCROLLBAR_NEVER, and false otherwise.
     * <p>
     * Note that even if this option is enabled, the BScrollPane will never make
     * the content Widget smaller than its minimum size or larger than its
     * maximum size.
     */
    ...
    /**
     * Set whether the BScrollPane should force the width of the content and
     * column header Widgets to exactly match the width of the visible area. By
     * default, this is true if the horizontal scrollbar policy was initialized
     * to SCROLLBAR_NEVER, and false otherwise.
     * <p>
    ...
    /**
     * Get whether the BScrollPane should force the height of the content and
     * row header Widgets to exactly match the height of the visible area. By
     * default, this is true if the vertical scrollbar policy was initialized to
     * SCROLLBAR_NEVER, and false otherwise.
     * <p>
     * Note that even if this option is enabled, the BScrollPane will never make
     * the content Widget smaller than its minimum size or larger than its
     * maximum size.
    ...
    /**
     * Set whether the BScrollPane should force the height of the content and
     * row header Widgets to exactly match the height of the visible area. By
     * default, this is true if the vertical scrollbar policy was initialized to
     * SCROLLBAR_NEVER, and false otherwise.
     * <p>
    ...
    /**
     * Remove a child Widget from this container. The scrollbars are built into
    ...
    /**
     * Remove the content, row header, and column header Widgets from this
     * container. The scrollbars are built into the scroll pane and may never be
    ...
    /**
     * This is a JScrollPane subclass which is the component for the
     * BScrollPane. It is nearly identical to WidgetContainerPanel, except that
     * it extends JScrollPane instead of JPanel.
     */
    ...
    /**
     * This is a BScrollBar subclass which is used for the scrollbars of the
     * BScrollPane. If the content Widget has a Component which implements
     * Scrollable, that Component is used for setting the unit and block
     * increments of the scrollbars.
     */
    ...
    /**
     * This inner class represents a scrollbar policy for the horizontal or
     * vertical scrollbar.
     */

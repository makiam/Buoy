...
/**
 * FormContainer is a WidgetContainer which arranges its children in a grid. The
 * width of each row and the height of each column may be different, and a
 * single Widget may occupy a rectangular block of cells.
 * <p>
 * The column widths and row heights are chosen based on the minimum and
 * preferred sizes of the widgets contained in them. If a FormContainer is made
 * larger than the preferred size required for its children, the extra space is
 * divided between rows and columns based on their weights. That is, a column
 * with weight 2.0 will have twice as much extra width added to it as a column
 * with weight 1.0. A row or column with weight 0.0 will never be made larger
 * than is required to hold its children.
 * <p>
 * In addition to the event types generated by all Widgets, FormContainers
...
public class FormContainer extends WidgetContainer {
    ...
    /**
     * Create a new FormContainer. All of the row and column weights default to
     * 1.0.
     *
    ...
    /**
     * Set the number of rows in this FormContainer. If this increases the
     * number of rows, the new rows will have weights of 1.0 by default. If this
     * decreases the number of rows, any child Widgets that extend beyond the
    ...
    /**
     * Set the number of columns in this FormContainer. If this increases the
     * number of columns, the new columns will have weights of 1.0 by default.
     * If this decreases the number of columns, any child Widgets that extend
    ...
    /**
     * Calculate the actual size of each row or column based on the minimum and
     * preferred sizes, the size of this container, and the row or column
     * weights.
     *
     ...
     * @param totalSize the total size of the container in the appropriate
     * dimension
    ...
    /**
     * Add a Widget to this container. The Widget will occupy a single cell, and
     * be positioned using the default LayoutInfo.
     *
    ...
    /**
     * Add a Widget to this container. The Widget will occupy a rectangular
     * block of cells, and be positioned using the default LayoutInfo.
     *
     * @param widget the Widget to add
     ...
     * @return a Rectangle specifying the range of rows and columns occupied by
     * the Widget
     */
     ...
     * @param cells a Rectangle specifying the range of rows and columns to be
     ...
     * @return a Rectangle specifying the range of rows and columns occupied by
     * the Widget, or null if the Widget is not a child of this container
     */
     ...
     * @param row true if row sizes should be calculated, false if column sizes

...
/**
 * A BRadioButton is a Widget for selecting between several options. It is
 * normally used as part of a {@link RadioButtonGroup RadioButtonGroup}. Each
 * BRadioButton represents a single option. Clicking on it selects it, and
 * deselects all other members of its RadioButtonGroup.
 * <p>
 * In addition to the event types generated by all Widgets, BRadioButtons
...
public class BRadioButton extends Widget<JRadioButton> {
    ...
    /**
     * Create the JRadioButton which serves as this Widget's Component. This
    ...
    /**
     * Set the selection state of this radio button. If you set the selection
     * state to true, the state of every other member of its RadioButtonGroup
